...
SEEDS = [
    ...
    {'category':'Training','region':'New York City','sponsor':'DockNYC Maritime Job Training Resources','posted':'Resource page','opening_date':'Check current training links','closing_date':'Rolling','details_url':'https://www.docknyc.com/job-training','type':'Maritime training directory','funding':'Mixed free, scholarship, and paid options','match':['job training','maritime industry','training programs']},
    {'category':'Training','region':'New York City','sponsor':'NYCEDC Offshore Wind and Maritime Workforce Programs','posted':'Workforce page','opening_date':'See program rollouts','closing_date':'Varies','details_url':'https://edc.nyc/workforce','type':'Maritime and offshore wind workforce training','funding':'Publicly funded programs and training investments','match':['maritime talent','workforce training','cuny']},
    {'category':'Scholarship','region':'New York City','sponsor':'SUNY Maritime Scholarships and Grants','posted':'Scholarship page','opening_date':'Check scholarship deadlines','closing_date':'Varies','details_url':'https://www.sunymaritime.edu/admissions/scholarships','type':'Maritime scholarship','funding':'Scholarships and grants','match':['scholarships and grants','scholarship assistance']},
    {'category':'Scholarship','region':'New York City','sponsor':'SUNY Maritime Scholarship Listing','posted':'Scholarship listing','opening_date':'Check provider deadlines','closing_date':'Varies','details_url':'https://www.sunymaritime.edu/admissions/scholarship-listing','type':'Maritime scholarship','funding':'Tuition-free and merit-based scholarship options','match':['excelsior scholarship','full-tuition scholarship','maritime scholarship']},
    {'category':'Training','region':'New York City','sponsor':'SUNY Maritime Professional Mariner Training','posted':'Program page','opening_date':'See course schedule','closing_date':'Rolling by course','details_url':'https://www.sunymaritime.edu/professional-mariner-training','type':'Paid maritime professional training','funding':'Paid courses','match':['individual courses','advance your career','corporate training']},
    {'category':'Training','region':'New York City','sponsor':'BoatUS New York Boating Safety Course','posted':'Course page','opening_date':'Open now','closing_date':'Rolling','details_url':'https://www.boatus.org/newyork','type':'Free boating safety course','funding':'Free online course; permanent card fee optional','match':['free online boating safety course','new york certificate']},
    {'category':'Training','region':'New York City','sponsor':'Hudson River Park Free Boating Safety Classes','posted':'Class schedule page','opening_date':'Register for upcoming dates','closing_date':'Varies by class','details_url':'https://hudsonriverpark.org/free-boating-safety-classes-with-the-u-s-coast-guard-auxiliary/','type':'Free boating safety class','funding':'Free','match':['free of charge','coast guard auxiliary','registration in advance']},
    {'category':'Job','region':'New York City','sponsor':'City of New York Jobs - Mariner','posted':'Job posting','opening_date':'See job posting','closing_date':'See job posting','details_url':'https://cityjobs.nyc.gov/job/mariner-in-nyc-all-boros-jid-40419','type':'Entry-level maritime-related job','funding':'Paid city job','match':['mariner','marine section','all boros']},
